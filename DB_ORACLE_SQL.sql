...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."INSERT_PUJA" (Ofrecido numeric, F date, FK_S int, FK_C int)
IS
BEGIN
	INSERT INTO Puja(
    Ofrecido, Fecha, ForeignKey_Subasta, ForeignKey_Comprador)
	VALUES (Ofrecido, F, FK_S, FK_C);
END;
...
IF Precio >= 0 THEN
	INSERT INTO Subasta(
	Imagen, Descripcion, DetallesEntrega, PrecioBase, FechaInicio, FechaFinal, ForeignKey_Vendedor, ForeignKey_Busqueda)
	VALUES (Img, Des, DetEntrega, Precio, FechaI, FechaF, FK_V, FK_B);
END IF;
END;
