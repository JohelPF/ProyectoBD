...
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Type ARRENTEROS
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."ARRENTEROS" IS VARRAY(1000) OF INT;

/
--------------------------------------------------------
--  DDL for Type ARRPARTES
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."ARRPARTES" IS VARRAY(1000) OF VARCHAR2(1000);

/
--------------------------------------------------------
--  DDL for Type COMPONENTE
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."COMPONENTE" UNDER Parte(
    PartesSubcomponentesOriginales INT,
    PartesBasicas INT,
    MEMBER FUNCTION CalculaOriginales RETURN INT,
    MEMBER FUNCTION CalculaBasica RETURN INT
)
 ALTER TYPE "SYSTEM"."COMPONENTE" ADD ATTRIBUTE CompuestoPartes ArrPartes
 ALTER TYPE "SYSTEM"."COMPONENTE" ADD ATTRIBUTE CompuestoComponentes ArrPartes
 ALTER TYPE "SYSTEM"."COMPONENTE" ADD ATTRIBUTE CantPartes ArrEnteros
 ALTER TYPE "SYSTEM"."COMPONENTE" ADD ATTRIBUTE CantCompuestos ArrEnteros
/
CREATE OR REPLACE NONEDITIONABLE TYPE BODY "SYSTEM"."COMPONENTE" AS 
MEMBER FUNCTION CalculaOriginales RETURN INT IS
        CantP INT;
        CantC INT;
    BEGIN
        CantP := 0; 
        CantC := 0;
        FOR i IN CantPartes.FIRST .. CantPartes.LAST
        LOOP
            CantP := CantP + CantPartes(i);
        END LOOP;
        FOR j IN CantCompuestos.FIRST .. CantCompuestos.LAST
        LOOP
            CantC := CantC + CantCompuestos(j);
        END LOOP;
        RETURN CantP+CantC;
    END;
MEMBER FUNCTION CalculaBasica RETURN INT IS
    CantP INT;
    CantC INT;
    Temp INT;
    BEGIN
        ...
        FOR j IN CantCompuestos.FIRST .. CantCompuestos.LAST
        LOOP
            IF (CantCompuestos(j) = 0) THEN
                CantC := CantC + CantCompuestos(j);
            ELSE
                SELECT PartesBasicas INTO Temp FROM Componentes WHERE Codigo = CompuestoComponentes(j);
                CantC := CantC + (CantCompuestos(j) * Temp);
            END IF;
        END LOOP;
        RETURN CantP+CantC;
    END;
...
/
--------------------------------------------------------
--  DDL for Type COMPRADORES
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."COMPRADORES" UNDER PARTICIPANTES();
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."PARTE" AS OBJECT(
...
/
--------------------------------------------------------
--  DDL for Type PARTICIPANTES
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."PARTICIPANTES" AS OBJECT (
    ID_PARTICIPANTE NUMBER,
    CORREOELECTRONICO VARCHAR2(100),
    NOMBRE VARCHAR2(100),
    "ALIAS" VARCHAR2(21),
    "PASSWORD" VARCHAR2(26),
    TELEFONO NUMBER,
    FOREIGNKEY_ADMINISTRADOR NUMBER
)NOT FINAL;

/
--------------------------------------------------------
--  DDL for Type VENDEDORES
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."VENDEDORES" UNDER PARTICIPANTES(CALIFICACION INT);
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."ADMINISTRADOR" 
   (	"ID_ADMINISTRADOR" NUMBER GENERATED ALWAYS AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"ALIAS" VARCHAR2(21 BYTE), 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
  GRANT ALTER ON "SYSTEM"."ADMINISTRADOR" TO "ADMINS";
  GRANT DELETE ON "SYSTEM"."ADMINISTRADOR" TO "ADMINS";
  GRANT INSERT ON "SYSTEM"."ADMINISTRADOR" TO "ADMINS";
  GRANT SELECT ON "SYSTEM"."ADMINISTRADOR" TO "ADMINS";
  GRANT UPDATE ON "SYSTEM"."ADMINISTRADOR" TO "ADMINS";
  GRANT READ ON "SYSTEM"."ADMINISTRADOR" TO "ADMINS";
  GRANT ON COMMIT REFRESH ON "SYSTEM"."ADMINISTRADOR" TO "ADMINS";
  GRANT QUERY REWRITE ON "SYSTEM"."ADMINISTRADOR" TO "ADMINS";
  GRANT DEBUG ON "SYSTEM"."ADMINISTRADOR" TO "ADMINS";
  GRANT FLASHBACK ON "SYSTEM"."ADMINISTRADOR" TO "ADMINS";
  GRANT DELETE ON "SYSTEM"."ADMINISTRADOR" TO "ADMINISTRADORES";
  GRANT INSERT ON "SYSTEM"."ADMINISTRADOR" TO "ADMINISTRADORES";
  GRANT SELECT ON "SYSTEM"."ADMINISTRADOR" TO "ADMINISTRADORES";
  GRANT UPDATE ON "SYSTEM"."ADMINISTRADOR" TO "ADMINISTRADORES";
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table BUSQUEDA
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."BUSQUEDA" 
   (	"ID_BUSQUEDA" NUMBER(*,0) GENERATED ALWAYS AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"CATEGORIA_PRIMARIA" VARCHAR2(100 BYTE), 
	"CATEGORIA_SECUNDARIA" VARCHAR2(100 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
  GRANT ALTER ON "SYSTEM"."BUSQUEDA" TO "ADMINS";
  GRANT DELETE ON "SYSTEM"."BUSQUEDA" TO "ADMINS";
  GRANT INSERT ON "SYSTEM"."BUSQUEDA" TO "ADMINS";
  GRANT SELECT ON "SYSTEM"."BUSQUEDA" TO "ADMINS";
  GRANT UPDATE ON "SYSTEM"."BUSQUEDA" TO "ADMINS";
  GRANT READ ON "SYSTEM"."BUSQUEDA" TO "ADMINS";
  GRANT ON COMMIT REFRESH ON "SYSTEM"."BUSQUEDA" TO "ADMINS";
  GRANT QUERY REWRITE ON "SYSTEM"."BUSQUEDA" TO "ADMINS";
  GRANT DEBUG ON "SYSTEM"."BUSQUEDA" TO "ADMINS";
  GRANT FLASHBACK ON "SYSTEM"."BUSQUEDA" TO "ADMINS";
  GRANT SELECT ON "SYSTEM"."BUSQUEDA" TO "USUARIO";
  GRANT DELETE ON "SYSTEM"."BUSQUEDA" TO "ADMINISTRADORES";
  GRANT INSERT ON "SYSTEM"."BUSQUEDA" TO "ADMINISTRADORES";
  GRANT SELECT ON "SYSTEM"."BUSQUEDA" TO "ADMINISTRADORES";
  GRANT UPDATE ON "SYSTEM"."BUSQUEDA" TO "ADMINISTRADORES";
  GRANT SELECT ON "SYSTEM"."BUSQUEDA" TO "PARTICIPANTES";
--------------------------------------------------------
--  DDL for Table CLASIFICACION
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."CLASIFICACION" 
   (	"ID_CLASIFICACION" NUMBER GENERATED ALWAYS AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"FOREIGNKEY_VENDEDOR" NUMBER, 
	"FOREIGNKEY_COMPRADOR" NUMBER, 
	"PUNTAJE" NUMBER(*,0), 
 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
  GRANT ALTER ON "SYSTEM"."CLASIFICACION" TO "ADMINS";
  GRANT DELETE ON "SYSTEM"."CLASIFICACION" TO "ADMINS";
  GRANT INSERT ON "SYSTEM"."CLASIFICACION" TO "ADMINS";
  GRANT SELECT ON "SYSTEM"."CLASIFICACION" TO "ADMINS";
  GRANT UPDATE ON "SYSTEM"."CLASIFICACION" TO "ADMINS";
  GRANT READ ON "SYSTEM"."CLASIFICACION" TO "ADMINS";
  GRANT ON COMMIT REFRESH ON "SYSTEM"."CLASIFICACION" TO "ADMINS";
  GRANT QUERY REWRITE ON "SYSTEM"."CLASIFICACION" TO "ADMINS";
  GRANT DEBUG ON "SYSTEM"."CLASIFICACION" TO "ADMINS";
  GRANT FLASHBACK ON "SYSTEM"."CLASIFICACION" TO "ADMINS";
  GRANT DELETE ON "SYSTEM"."CLASIFICACION" TO "USUARIO";
  GRANT INSERT ON "SYSTEM"."CLASIFICACION" TO "USUARIO";
  GRANT SELECT ON "SYSTEM"."CLASIFICACION" TO "USUARIO";
  GRANT UPDATE ON "SYSTEM"."CLASIFICACION" TO "USUARIO";
  GRANT DELETE ON "SYSTEM"."CLASIFICACION" TO "ADMINISTRADORES";
  GRANT INSERT ON "SYSTEM"."CLASIFICACION" TO "ADMINISTRADORES";
  GRANT SELECT ON "SYSTEM"."CLASIFICACION" TO "ADMINISTRADORES";
  GRANT UPDATE ON "SYSTEM"."CLASIFICACION" TO "ADMINISTRADORES";
  GRANT DELETE ON "SYSTEM"."CLASIFICACION" TO "PARTICIPANTES";
  GRANT INSERT ON "SYSTEM"."CLASIFICACION" TO "PARTICIPANTES";
  GRANT SELECT ON "SYSTEM"."CLASIFICACION" TO "PARTICIPANTES";
  GRANT UPDATE ON "SYSTEM"."CLASIFICACION" TO "PARTICIPANTES";
--------------------------------------------------------
--  DDL for Table COMPRADOR
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."COMPRADOR" OF "SYSTEM"."COMPRADORES" 
 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
  GRANT ALTER ON "SYSTEM"."COMPRADOR" TO "ADMINS";
  GRANT DELETE ON "SYSTEM"."COMPRADOR" TO "ADMINS";
  GRANT INSERT ON "SYSTEM"."COMPRADOR" TO "ADMINS";
  GRANT SELECT ON "SYSTEM"."COMPRADOR" TO "ADMINS";
  GRANT UPDATE ON "SYSTEM"."COMPRADOR" TO "ADMINS";
  GRANT READ ON "SYSTEM"."COMPRADOR" TO "ADMINS";
  GRANT ON COMMIT REFRESH ON "SYSTEM"."COMPRADOR" TO "ADMINS";
  GRANT QUERY REWRITE ON "SYSTEM"."COMPRADOR" TO "ADMINS";
  GRANT DEBUG ON "SYSTEM"."COMPRADOR" TO "ADMINS";
  GRANT FLASHBACK ON "SYSTEM"."COMPRADOR" TO "ADMINS";
  GRANT SELECT ON "SYSTEM"."COMPRADOR" TO "USUARIO";
  GRANT DELETE ON "SYSTEM"."COMPRADOR" TO "ADMINISTRADORES";
  GRANT INSERT ON "SYSTEM"."COMPRADOR" TO "ADMINISTRADORES";
  GRANT SELECT ON "SYSTEM"."COMPRADOR" TO "ADMINISTRADORES";
  GRANT UPDATE ON "SYSTEM"."COMPRADOR" TO "ADMINISTRADORES";
  GRANT SELECT ON "SYSTEM"."COMPRADOR" TO "PARTICIPANTES";
--------------------------------------------------------
--  DDL for Table HELP
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSAUX" ;
--------------------------------------------------------
--  DDL for Table METODODEPAGO
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."METODODEPAGO" 
   (	"ID_METODODEPAGO" NUMBER(*,0), 
	"ID_CLIENTE" NUMBER(*,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
--------------------------------------------------------
--  DDL for Table PARTES
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."PARTES" OF "SYSTEM"."PARTE" 
 OIDINDEX  ( PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table PARTICIPANTE
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."PARTICIPANTE" OF "SYSTEM"."PARTICIPANTES" 
 OIDINDEX  ( PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
  GRANT ALTER ON "SYSTEM"."PARTICIPANTE" TO "ADMINS";
  GRANT DELETE ON "SYSTEM"."PARTICIPANTE" TO "ADMINS";
  GRANT INSERT ON "SYSTEM"."PARTICIPANTE" TO "ADMINS";
  GRANT SELECT ON "SYSTEM"."PARTICIPANTE" TO "ADMINS";
  GRANT UPDATE ON "SYSTEM"."PARTICIPANTE" TO "ADMINS";
  GRANT READ ON "SYSTEM"."PARTICIPANTE" TO "ADMINS";
  GRANT UNDER ON "SYSTEM"."PARTICIPANTE" TO "ADMINS";
  GRANT ON COMMIT REFRESH ON "SYSTEM"."PARTICIPANTE" TO "ADMINS";
  GRANT QUERY REWRITE ON "SYSTEM"."PARTICIPANTE" TO "ADMINS";
  GRANT DEBUG ON "SYSTEM"."PARTICIPANTE" TO "ADMINS";
  GRANT FLASHBACK ON "SYSTEM"."PARTICIPANTE" TO "ADMINS";
  GRANT SELECT ON "SYSTEM"."PARTICIPANTE" TO "USUARIO";
  GRANT DELETE ON "SYSTEM"."PARTICIPANTE" TO "ADMINISTRADORES";
  GRANT INSERT ON "SYSTEM"."PARTICIPANTE" TO "ADMINISTRADORES";
  GRANT SELECT ON "SYSTEM"."PARTICIPANTE" TO "ADMINISTRADORES";
  GRANT UPDATE ON "SYSTEM"."PARTICIPANTE" TO "ADMINISTRADORES";
  GRANT SELECT ON "SYSTEM"."PARTICIPANTE" TO "PARTICIPANTES";
--------------------------------------------------------
--  DDL for Table PUJA
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."PUJA" 
   (	"ID_PUJA" NUMBER, 
	"OFRECIDO" NUMBER, 
	"FECHA" DATE, 
	"FOREIGNKEY_SUBASTA" NUMBER, 
	"FOREIGNKEY_COMPRADOR" NUMBER
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
  GRANT ALTER ON "SYSTEM"."PUJA" TO "ADMINS";
  GRANT DELETE ON "SYSTEM"."PUJA" TO "ADMINS";
  GRANT INSERT ON "SYSTEM"."PUJA" TO "ADMINS";
  GRANT SELECT ON "SYSTEM"."PUJA" TO "ADMINS";
  GRANT UPDATE ON "SYSTEM"."PUJA" TO "ADMINS";
  GRANT READ ON "SYSTEM"."PUJA" TO "ADMINS";
  GRANT ON COMMIT REFRESH ON "SYSTEM"."PUJA" TO "ADMINS";
  GRANT QUERY REWRITE ON "SYSTEM"."PUJA" TO "ADMINS";
  GRANT DEBUG ON "SYSTEM"."PUJA" TO "ADMINS";
  GRANT FLASHBACK ON "SYSTEM"."PUJA" TO "ADMINS";
  GRANT DELETE ON "SYSTEM"."PUJA" TO "USUARIO";
  GRANT INSERT ON "SYSTEM"."PUJA" TO "USUARIO";
  GRANT SELECT ON "SYSTEM"."PUJA" TO "USUARIO";
  GRANT UPDATE ON "SYSTEM"."PUJA" TO "USUARIO";
  GRANT DELETE ON "SYSTEM"."PUJA" TO "ADMINISTRADORES";
  GRANT INSERT ON "SYSTEM"."PUJA" TO "ADMINISTRADORES";
  GRANT SELECT ON "SYSTEM"."PUJA" TO "ADMINISTRADORES";
  GRANT UPDATE ON "SYSTEM"."PUJA" TO "ADMINISTRADORES";
  GRANT DELETE ON "SYSTEM"."PUJA" TO "PARTICIPANTES";
  GRANT INSERT ON "SYSTEM"."PUJA" TO "PARTICIPANTES";
  GRANT SELECT ON "SYSTEM"."PUJA" TO "PARTICIPANTES";
  GRANT UPDATE ON "SYSTEM"."PUJA" TO "PARTICIPANTES";
  GRANT DELETE ON "SYSTEM"."PUJA" TO PUBLIC;
  GRANT INSERT ON "SYSTEM"."PUJA" TO PUBLIC;
  GRANT SELECT ON "SYSTEM"."PUJA" TO PUBLIC;
  GRANT UPDATE ON "SYSTEM"."PUJA" TO PUBLIC;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."SUBASTA" 
   (	"ID_SUBASTA" NUMBER GENERATED ALWAYS AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"IMAGEN" BFILE, 
	"DESCRIPCION" VARCHAR2(500 BYTE), 
	"DETALLESENTREGA" VARCHAR2(100 BYTE), 
	"PRECIOBASE" NUMBER, 
	"PRECIOFINAL" NUMBER, 
	"FECHAINICIO" DATE, 
	"FECHAFINAL" DATE, 
	"FOREIGNKEY_VENDEDOR" NUMBER, 
	"FOREIGNKEY_BUSQUEDA" NUMBER
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
  GRANT ALTER ON "SYSTEM"."SUBASTA" TO "ADMINS";
  GRANT DELETE ON "SYSTEM"."SUBASTA" TO "ADMINS";
  GRANT INSERT ON "SYSTEM"."SUBASTA" TO "ADMINS";
  GRANT SELECT ON "SYSTEM"."SUBASTA" TO "ADMINS";
  GRANT UPDATE ON "SYSTEM"."SUBASTA" TO "ADMINS";
  GRANT READ ON "SYSTEM"."SUBASTA" TO "ADMINS";
  GRANT ON COMMIT REFRESH ON "SYSTEM"."SUBASTA" TO "ADMINS";
  GRANT QUERY REWRITE ON "SYSTEM"."SUBASTA" TO "ADMINS";
  GRANT DEBUG ON "SYSTEM"."SUBASTA" TO "ADMINS";
  GRANT FLASHBACK ON "SYSTEM"."SUBASTA" TO "ADMINS";
  GRANT DELETE ON "SYSTEM"."SUBASTA" TO "USUARIO";
  GRANT INSERT ON "SYSTEM"."SUBASTA" TO "USUARIO";
  GRANT SELECT ON "SYSTEM"."SUBASTA" TO "USUARIO";
  GRANT UPDATE ON "SYSTEM"."SUBASTA" TO "USUARIO";
  GRANT DELETE ON "SYSTEM"."SUBASTA" TO "ADMINISTRADORES";
  GRANT INSERT ON "SYSTEM"."SUBASTA" TO "ADMINISTRADORES";
  GRANT SELECT ON "SYSTEM"."SUBASTA" TO "ADMINISTRADORES";
  GRANT UPDATE ON "SYSTEM"."SUBASTA" TO "ADMINISTRADORES";
  GRANT DELETE ON "SYSTEM"."SUBASTA" TO "PARTICIPANTES";
  GRANT INSERT ON "SYSTEM"."SUBASTA" TO "PARTICIPANTES";
  GRANT SELECT ON "SYSTEM"."SUBASTA" TO "PARTICIPANTES";
  GRANT UPDATE ON "SYSTEM"."SUBASTA" TO "PARTICIPANTES";
  GRANT DELETE ON "SYSTEM"."SUBASTA" TO PUBLIC;
  GRANT INSERT ON "SYSTEM"."SUBASTA" TO PUBLIC;
  GRANT SELECT ON "SYSTEM"."SUBASTA" TO PUBLIC;
  GRANT UPDATE ON "SYSTEM"."SUBASTA" TO PUBLIC;
--------------------------------------------------------
--  DDL for Table VENDEDOR
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."VENDEDOR" OF "SYSTEM"."VENDEDORES" 
 OIDINDEX  ( PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
  GRANT ALTER ON "SYSTEM"."VENDEDOR" TO "ADMINS";
  GRANT DELETE ON "SYSTEM"."VENDEDOR" TO "ADMINS";
  GRANT INSERT ON "SYSTEM"."VENDEDOR" TO "ADMINS";
  GRANT SELECT ON "SYSTEM"."VENDEDOR" TO "ADMINS";
  GRANT UPDATE ON "SYSTEM"."VENDEDOR" TO "ADMINS";
  GRANT READ ON "SYSTEM"."VENDEDOR" TO "ADMINS";
  GRANT ON COMMIT REFRESH ON "SYSTEM"."VENDEDOR" TO "ADMINS";
  GRANT QUERY REWRITE ON "SYSTEM"."VENDEDOR" TO "ADMINS";
  GRANT DEBUG ON "SYSTEM"."VENDEDOR" TO "ADMINS";
  GRANT FLASHBACK ON "SYSTEM"."VENDEDOR" TO "ADMINS";
  GRANT SELECT ON "SYSTEM"."VENDEDOR" TO "USUARIO";
  GRANT DELETE ON "SYSTEM"."VENDEDOR" TO "ADMINISTRADORES";
  GRANT INSERT ON "SYSTEM"."VENDEDOR" TO "ADMINISTRADORES";
  GRANT SELECT ON "SYSTEM"."VENDEDOR" TO "ADMINISTRADORES";
  GRANT UPDATE ON "SYSTEM"."VENDEDOR" TO "ADMINISTRADORES";
  GRANT SELECT ON "SYSTEM"."VENDEDOR" TO "PARTICIPANTES";
--------------------------------------------------------
...
REM INSERTING into SYSTEM.ADMINISTRADOR
SET DEFINE OFF;
Insert into SYSTEM.ADMINISTRADOR (ID_ADMINISTRADOR,ALIAS,PASSWORD) values (21,'admin1','admin1pw');
Insert into SYSTEM.ADMINISTRADOR (ID_ADMINISTRADOR,ALIAS,PASSWORD) values (22,'admin2','admin2pw');
Insert into SYSTEM.ADMINISTRADOR (ID_ADMINISTRADOR,ALIAS,PASSWORD) values (41,'admin3','admin3pw');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.BUSQUEDA
SET DEFINE OFF;
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (176,'Antigüedades','Antigüedades');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (177,'Antigüedades','Arquitectónico y jardín');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (178,'Antigüedades','Antigüedades de Asia');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (179,'Antigüedades','Libros y manuscritos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (180,'Antigüedades','Artes decorativas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (181,'Antigüedades','Etnográfico');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (182,'Antigüedades','Muebles');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (183,'Antigüedades','Hogar y chimeneas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (184,'Antigüedades','Linos y textiles (antes de 1930)');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (185,'Antigüedades','Mapas, atlas y globos terráqueos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (186,'Antigüedades','Marítimo');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (187,'Antigüedades','Mercantil, comercio y fábricas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (188,'Antigüedades','Instrumentos musicales (antes de 1930)');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (189,'Antigüedades','Épocas y estilos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (190,'Antigüedades','Primitivos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (191,'Antigüedades','Restauración y cuidado');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (192,'Antigüedades','Alfombras y tapetes');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (193,'Antigüedades','Ciencia y medicina (antes de 1930)');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (194,'Antigüedades','Costura (antes de 1930)');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (195,'Antigüedades','Plateado');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (196,'Antigüedades','Réplicas de antigüedades');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (197,'Antigüedades','Otros');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (198,'Arte','Directo del artista');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (199,'Arte','Arte de anticuarios y revendedores');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (200,'Arte','Lotes al por mayor');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (201,'Bebés','Artículos para bebé');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (202,'Bebés','Seguridad y salud del bebé');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (203,'Bebés','Baño y aseo');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (204,'Bebés','Asientos de seguridad para autos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (205,'Bebés','Pañales');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (206,'Bebés','Alimentación');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (207,'Bebés','Recuerdos y anuncios de nacimiento');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (208,'Bebés','Ropa de cama para niños');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (209,'Bebés','Decoración de habitaciones de bebé');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (210,'Bebés','Muebles para bebés');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (211,'Bebés','Dejar los pañales');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (212,'Bebés','Coches para bebés');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (213,'Bebés','Accesorios para coches');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (214,'Bebés','Juguetes para bebés');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (215,'Bebés','Otros');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (216,'Libros','Accesorios');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (217,'Libros','Antigüedades y piezas de colección');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (218,'Libros','Libro en audio');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (219,'Libros','Catálogos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (220,'Libros','Niños y adultos jóvenes');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (221,'Libros','Libros de cocina');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (222,'Libros','Ficción y literatura');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (223,'Libros','Publicaciones anteriores de revistas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (224,'Libros','No ficción');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (225,'Libros','Libros de textos, educación');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (226,'Libros','Otros');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (227,'Equipo y maquinaria industrial','Agricultura y silvicultura');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (228,'Equipo y maquinaria industrial','Construcción');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (229,'Equipo y maquinaria industrial','Equipo eléctrico y de prueba');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (230,'Equipo y maquinaria industrial','Combustible y energía');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (231,'Equipo y maquinaria industrial','Cuidado de salud y laboratorio');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (232,'Equipo y maquinaria industrial','Equipo pesado');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (233,'Equipo y maquinaria industrial','Accesorios de equipo pesado');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (234,'Equipo y maquinaria industrial','Piezas y accesorios de equipo pesado');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (235,'Equipo y maquinaria industrial','Equipo ligero y herramientas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (236,'Equipo y maquinaria industrial','Manufactura y metalurgia');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (237,'Equipo y maquinaria industrial','Suministro industrial y MRO');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (238,'Equipo y maquinaria industrial','Oficina');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (239,'Equipo y maquinaria industrial','Empaque y envío');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (240,'Equipo y maquinaria industrial','Artes gráficas y de impresión');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (241,'Equipo y maquinaria industrial','Restaurante y catering');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (242,'Equipo y maquinaria industrial','Sitios en internet y negocios en venta');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (243,'Equipo y maquinaria industrial','Otros');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (244,'Cámaras y fotografía','Binoculares y telescopios');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (245,'Cámaras y fotografía','Drones con cámaras');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (246,'Cámaras y fotografía','Cámara de video');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (247,'Cámaras y fotografía','Cámaras digitales');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (248,'Cámaras y fotografía','Accesorios de cámaras y fotografía');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (249,'Cámaras y fotografía','Marcos de fotos digitales');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (250,'Cámaras y fotografía','Fotografía de película');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (251,'Cámaras y fotografía','Flashes y accesorios');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (252,'Cámaras y fotografía','Lentes y filtros');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (253,'Cámaras y fotografía','Iluminación y estudio');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (254,'Cámaras y fotografía','Manuales y guías');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (255,'Cámaras y fotografía','Piezas y herramientas de repuesto');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (256,'Cámaras y fotografía','Trípodes y soportes');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (257,'Cámaras y fotografía','Edición y producción de video');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (258,'Cámaras y fotografía','Fotografías y películas vintage');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (259,'Cámaras y fotografía','Lotes al por mayor');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (260,'Cámaras y fotografía','Otros');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (261,'Teléfonos celulares y accesorios','Celulares y smartphones');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (262,'Teléfonos celulares y accesorios','Relojes inteligentes');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (263,'Teléfonos celulares y accesorios','Accesorios para teléfonos celulares');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (264,'Teléfonos celulares y accesorios','Teléfonos con display');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (265,'Teléfonos celulares y accesorios','Tarjetas SIM y tarjetas telefónicas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (266,'Teléfonos celulares y accesorios','Piezas y herramientas de repuesto');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (267,'Teléfonos celulares y accesorios','Otros');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (268,'Ropa, zapatos y accesorios','Ropa de infantes y bebés');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (269,'Ropa, zapatos y accesorios','Vestuario, zapatos y accesorios de niños');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (270,'Ropa, zapatos y accesorios','Disfraces, representación, teatro');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (271,'Ropa, zapatos y accesorios','Ropa étnica y cultural');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (272,'Ropa, zapatos y accesorios','Trajes de baile');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (273,'Ropa, zapatos y accesorios','Accesorios para hombre');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (274,'Ropa, zapatos y accesorios','Ropa para hombre');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (275,'Ropa, zapatos y accesorios','Zapatos para hombres');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (276,'Ropa, zapatos y accesorios','Uniformes y ropa de trabajo');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (277,'Ropa, zapatos y accesorios','Vestuario, zapatos y accesorios unisex');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (278,'Ropa, zapatos y accesorios','Boda y ocasión formal');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (279,'Ropa, zapatos y accesorios','Accesorios para mujer');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (280,'Ropa, zapatos y accesorios','Ropa para mujer');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (281,'Ropa, zapatos y accesorios','Carteras y bolsos de mujer');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (282,'Ropa, zapatos y accesorios','Calzado de mujer');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (283,'Ropa, zapatos y accesorios','Vintage');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (284,'Ropa, zapatos y accesorios','Lotes grandes y pequeños al por mayor');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (285,'Monedas y billetes','En lingotes');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (286,'Monedas y billetes','Monedas: EE. UU.');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (287,'Monedas y billetes','Monedas: Canadá');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (288,'Monedas y billetes','Monedas: antiguas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (289,'Monedas y billetes','Monedas: Edad Media');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (290,'Monedas y billetes','Monedas: del mundo');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (291,'Monedas y billetes','Objetos numismáticos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (292,'Monedas y billetes','Billetes: EE. UU.');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (293,'Monedas y billetes','Billetes del mundo');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (294,'Monedas y billetes','Publicaciones y suministros');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (295,'Monedas y billetes','Acciones y bonos, escripofilia');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (296,'Monedas y billetes','Divisa virtual');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (297,'Monedas y billetes','Otros');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (298,'Artículos de colección','Publicidad');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (299,'Artículos de colección','Animales');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (300,'Artículos de colección','Dibujos animados y personajes');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (301,'Artículos de colección','Salas de juegos, rocolas y pinball');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (302,'Artículos de colección','Autógrafos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (303,'Artículos de colección','Bancos, registros y ventas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (304,'Artículos de colección','Artículos de bar');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (305,'Artículos de colección','Cuentas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (306,'Artículos de colección','Botellas y aisladores');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (307,'Artículos de colección','Breweriana, cerveza');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (308,'Artículos de colección','Casino');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (309,'Artículos de colección','Relojes');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (310,'Artículos de colección','Cómics');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (311,'Artículos de colección','Culturas y etnias');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (312,'Artículos de colección','Adornos de colección');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (313,'Artículos de colección','Disneyana');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (314,'Artículos de colección','Fantasía, míticos y magia');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (315,'Artículos de colección','Memorabilia histórica');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (316,'Artículos de colección','Festivo y de temporada');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (317,'Artículos de colección','Cocina y hogar');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (318,'Artículos de colección','Cuchillos, espadas y cuchillas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (319,'Artículos de colección','Lámparas, luces');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (320,'Artículos de colección','Ropa blanca y telas (1930 - presente)');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (321,'Artículos de colección','Objetos de metal');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (322,'Artículos de colección','Militaria');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (323,'Artículos de colección','Papel');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (324,'Artículos de colección','Bolígrafos e instrumentos para escribir');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (325,'Artículos de colección','Pez, llaveros, vasos promocionales');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (326,'Artículos de colección','Imágenes fotográficas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (327,'Artículos de colección','Prendedores, cabezones, loncheras');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (328,'Artículos de colección','Postales');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (329,'Artículos de colección','Radio, fonógrafo, televisión, teléfono');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (330,'Artículos de colección','Religión y espiritualidad');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (331,'Artículos de colección','Rocas, fósiles y minerales');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (332,'Artículos de colección','Ciencia ficción y horror');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (333,'Artículos de colección','Ciencia y medicina (1930 - presente)');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (334,'Artículos de colección','Costura (1930 - presente)');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (335,'Artículos de colección','Recuerdos y memorabilia de viajes');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (336,'Artículos de colección','Productos relacionados con el tabaco');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (337,'Artículos de colección','Herramientas y cerraduras');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (338,'Artículos de colección','Tarjetas de colección');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (339,'Artículos de colección','Transporte');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (340,'Artículos de colección','Tocador, perfume y productos de afeitar');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (341,'Artículos de colección','Vintage, retro, de mediados de siglo');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (342,'Computadoras, tablets y redes','iPads, tablets y lectores electrónicos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (343,'Computadoras, tablets y redes','Accesorios para iPad/Tableta/eBook');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (344,'Computadoras, tablets y redes','Tablet & eBook Reader Parts');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (345,'Computadoras, tablets y redes','Laptops y netbooks');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (346,'Computadoras, tablets y redes','Computadoras y todo en uno');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (347,'Computadoras, tablets y redes','Accs. para laptops y comp. de escritorio');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (348,'Computadoras, tablets y redes','Cables y conectores');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (349,'Computadoras, tablets y redes','Partes y componentes de computadora');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (350,'Computadoras, tablets y redes','Unidades de disco, almacenamiento y discos en blanco');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (351,'Computadoras, tablets y redes','Redes y servidores empresariales');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (352,'Computadoras, tablets y redes','Red y conectividad doméstica');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (353,'Computadoras, tablets y redes','Teclados, mouses y punteros');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (354,'Computadoras, tablets y redes','Monitores, proyectores y accesorios');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (355,'Computadoras, tablets y redes','Protección, distribución de alimentación');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (356,'Computadoras, tablets y redes','Impresoras, escáneres y suministros');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (357,'Computadoras, tablets y redes','Software');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (358,'Computadoras, tablets y redes','Manuales y recursos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (359,'Computadoras, tablets y redes','Informática vintage');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (360,'Computadoras, tablets y redes','Otros');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (361,'Artículos electrónicos','Audio portátil y audífonos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (362,'Artículos electrónicos','Televisor, video y audio para el hogar');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (363,'Artículos electrónicos','Sistemas electrónicos del vehículo y GPS');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (364,'Artículos electrónicos','Sistemas de automatización (domótica)');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (365,'Artículos electrónicos','Vigilancia residencial');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (366,'Artículos electrónicos','Teléfonos para el hogar');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (367,'Artículos electrónicos','Baterías y energías multiusos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (368,'Artículos electrónicos','Comunicación por radio');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (369,'Artículos electrónicos','Artefactos y otros sistemas electrónicos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (370,'Artículos electrónicos','Sistemas electrónicos vintage');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (371,'Artesanías','Materiales para arte');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (372,'Artesanías','Cuentas y fabricación de joyas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (373,'Artesanías','Vidrio y mosaicos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (374,'Artesanías','Piezas de artesanía y acabadas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (375,'Artesanías','Artes y artesanías para el hogar');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (376,'Artesanías','Artesanías infantiles');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (377,'Artesanías','Materiales multiusos para artesanía');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (378,'Artesanías','Artesanías con agujas e hilos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (379,'Artesanías','Colec. de recortes y artesanías de papel');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (380,'Artesanías','Costura y tela');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (381,'Artesanías','Timbres y gofrados');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (382,'Artesanías','Otras artesanías');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (383,'Muñecas y osos','Materiales para hacer osos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (384,'Muñecas y osos','Osos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (385,'Muñecas y osos','Muñecas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (386,'Muñecas y osos','Miniaturas para casas de muñeca');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (387,'Muñecas y osos','Muñecas de papel');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (388,'Películas y DVD','DVD y Blu-ray');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (389,'Películas y DVD','Película fotográfica');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (390,'Películas y DVD','Discos láser');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (391,'Películas y DVD','UMD');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (392,'Películas y DVD','Cintas VHS');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (393,'Películas y DVD','Otros formatos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (394,'Películas y DVD','Almacenamiento y accesorios para videos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (395,'Vehículos','Vehículos y camionetas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (396,'Vehículos','Motocicletas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (397,'Vehículos','Otros vehículos y remolques');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (398,'Vehículos','Botes');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (399,'Vehículos','Vehículos de aventura, recreativos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (400,'Vehículos','Partes y accesorios');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (401,'Memorabilia de entretenimiento','Autógrafos-original');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (402,'Memorabilia de entretenimiento','Autógrafos-reimpresos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (403,'Memorabilia de entretenimiento','Memorabilia de películas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (404,'Memorabilia de entretenimiento','Memorabilia de música');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (405,'Memorabilia de entretenimiento','Memorabilia de televisión');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (406,'Memorabilia de entretenimiento','Memorabilia de teatro');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (407,'Memorabilia de entretenimiento','Memorabilia de juegos de video');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (408,'Memorabilia de entretenimiento','Otros');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (409,'Tarjetas de regalo y cupones','Tarjetas de regalo');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (410,'Tarjetas de regalo y cupones','Tarjetas de regalo de eBay');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (411,'Tarjetas de regalo y cupones','Certificados de regalo');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (412,'Tarjetas de regalo y cupones','Cupones');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (413,'Tarjetas de regalo y cupones','Productos digitales');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (414,'Belleza y salud','Cuerpo y baño');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (415,'Belleza y salud','Suplementos alimenticios, nutrición');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (416,'Belleza y salud','Fragancias');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (417,'Belleza y salud','Cuidado del cabello y peinado');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (418,'Belleza y salud','Cuidado de la salud');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (419,'Belleza y salud','Maquillaje');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (420,'Belleza y salud','Masaje');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (421,'Belleza y salud','Medicina, movilidad y discapacidad');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (422,'Belleza y salud','Cuidado de las uñas, manicure y pedicure');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (423,'Belleza y salud','Remedios naturales y homeopáticos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (424,'Belleza y salud','Higiene bucal');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (425,'Belleza y salud','Medicamentos de venta libre');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (426,'Belleza y salud','Equipo de spa y salón');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (427,'Belleza y salud','Afeitado y depilación');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (428,'Belleza y salud','Cuidado de la piel');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (429,'Belleza y salud','Protección solar y bronceador');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (430,'Belleza y salud','Tatuajes y arte corporal');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (431,'Belleza y salud','Cuidado de la vista');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (432,'Belleza y salud','Control de peso');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (433,'Belleza y salud','Lotes al por mayor');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (434,'Belleza y salud','Otros');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (435,'Casa y jardín','Baño');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (436,'Casa y jardín','Ropa de cama');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (437,'Casa y jardín','Comida y bebidas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (438,'Casa y jardín','Flores naturales y suministros');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (439,'Casa y jardín','Muebles');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (440,'Casa y jardín','Tarjetas y suministros para fiestas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (441,'Casa y jardín','Decoración festiva y de temporada');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (442,'Casa y jardín','Decoración para el hogar');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (443,'Casa y jardín','Artículos para mejoras del hogar');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (444,'Casa y jardín','Materiales de limpieza para el hogar');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (445,'Casa y jardín','Niños y adolescentes');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (446,'Casa y jardín','Cocina, comedor y bar');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (447,'Casa y jardín','Lámparas, luces y ventiladores de techo');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (448,'Casa y jardín','Electrodomésticos grandes');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (449,'Casa y jardín','Alfombras y tapetes');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (450,'Casa y jardín','Herramientas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (451,'Casa y jardín','Suministros para soldadura');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (452,'Casa y jardín','Decoración y herrajes para ventanas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (453,'Casa y jardín','Patio, jardín y espacios abiertos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (454,'Casa y jardín','Lotes al por mayor');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (455,'Casa y jardín','Otros');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (456,'Joyería y relojes','Joyas infantiles');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (457,'Joyería y relojes','Compromiso y boda');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (458,'Joyería y relojes','Étnicos, regionales y tribales');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (459,'Joyería y relojes','Joyas de moda');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (460,'Joyería y relojes','Joyería fina');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (461,'Joyería y relojes','Joyas artesanales, hechas a mano');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (462,'Joyería y relojes','Joyeros y organizadores de joyas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (463,'Joyería y relojes','Diseño y reparación de joyas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (464,'Joyería y relojes','Cuentas sueltas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (465,'Joyería y relojes','Diamantes y gemas sueltos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (466,'Joyería y relojes','Joyas para hombres');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (467,'Joyería y relojes','Joyas vintage y antiguas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (468,'Joyería y relojes','Relojes');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (469,'Joyería y relojes','Otros');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (470,'Música','Casetes');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (471,'Música','CD');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (472,'Música','Discos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (473,'Música','Otros formatos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (474,'Música','Almacenamiento y accesorios para videos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (475,'Música','Lotes al por mayor');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (476,'Instrumentos y equipos musicales','Acordeones y concertinas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (477,'Instrumentos y equipos musicales','Latón');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (478,'Instrumentos y equipos musicales','Equipo');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (479,'Instrumentos y equipos musicales','Guitarra');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (480,'Instrumentos y equipos musicales','Armónica');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (481,'Instrumentos y equipos musicales','Libros, CD y videos de instrucciones');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (482,'Instrumentos y equipos musicales','Karaoke');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (483,'Instrumentos y equipos musicales','Percusión');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (484,'Instrumentos y equipos musicales','Pianos, órganos y teclados');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (485,'Instrumentos y equipos musicales','Equipo de audio profesional');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (486,'Instrumentos y equipos musicales','Partituras y cancioneros');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (487,'Instrumentos y equipos musicales','Iluminación y efectos de escenario');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (488,'Instrumentos y equipos musicales','Cuerdas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (489,'Instrumentos y equipos musicales','Instrumentos de viento-madera');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (490,'Instrumentos y equipos musicales','Lotes al por mayor');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (491,'Instrumentos y equipos musicales','Otros');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (492,'Productos para mascotas','Aves de corral');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (493,'Productos para mascotas','Aves');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (494,'Productos para mascotas','Gatos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (495,'Productos para mascotas','Perros');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (496,'Productos para mascotas','Peces y acuarios');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (497,'Productos para mascotas','Caballos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (498,'Productos para mascotas','Reptiles');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (499,'Productos para mascotas','Animales pequeños');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (500,'Productos para mascotas','Lápidas y urnas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (501,'Productos para mascotas','Otros');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (502,'Cerámica y vidrio','Vidrio');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (503,'Cerámica y vidrio','Cerámica y porcelana');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (504,'Bienes raíces','Comerciales');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (505,'Bienes raíces','Terreno');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (506,'Bienes raíces','Casas prefabricadas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (507,'Bienes raíces','Residenciales');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (508,'Bienes raíces','Tiempos compartidos a la venta');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (509,'Bienes raíces','Otros bienes raíces');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (510,'Servicios especiales','Servicios artísticos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (511,'Servicios especiales','Ropa y joyería a la medida');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (512,'Servicios especiales','Servicios de subastas de eBay');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (513,'Servicios especiales','Diseño gráfico y de logotipos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (514,'Servicios especiales','Servicios para mejoras del hogar');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (515,'Servicios especiales','Servicios basados en artículos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (516,'Servicios especiales','Edición y duplicado de medios');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (517,'Servicios especiales','Impresión y personalización');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (518,'Servicios especiales','Restauración y reparación');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (519,'Servicios especiales','Servicios Web e informáticos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (520,'Servicios especiales','Otros servicios');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (521,'Artículos deportivos','Boxeo, artes marciales y artes marciales mixtas (MMA)');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (522,'Artículos deportivos','Ciclismo');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (523,'Artículos deportivos','Pesca');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (524,'Artículos deportivos','Fitness, running y yoga');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (525,'Artículos deportivos','Golf');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (526,'Artículos deportivos','Cacería');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (527,'Artículos deportivos','Juegos en interiores');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (528,'Artículos deportivos','Deportes al aire libre');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (529,'Artículos deportivos','Deportes de equipo');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (530,'Artículos deportivos','Tenis y deportes con raqueta');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (531,'Artículos deportivos','Deportes acuáticos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (532,'Artículos deportivos','Deportes de invierno');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (533,'Artículos deportivos','Otros');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (534,'Artículos deportivos','Lotes al por mayor');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (535,'Memorabilia de deporte, tarjetas, fans','Autógrafos (original)');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (536,'Memorabilia de deporte, tarjetas, fans','Autógrafos (reimpresos)');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (537,'Memorabilia de deporte, tarjetas, fans','Tarjetas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (538,'Memorabilia de deporte, tarjetas, fans','Ropa para aficionados y recuerdos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (539,'Memorabilia de deporte, tarjetas, fans','Memorabilia de juegos usada');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (540,'Memorabilia de deporte, tarjetas, fans','Autenticada por el fabricante');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (541,'Memorabilia de deporte, tarjetas, fans','Memorabilia de deportes antigua');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (542,'Memorabilia de deporte, tarjetas, fans','Lotes al por mayor');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (543,'Estampillas','Estados Unidos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (544,'Estampillas','Canadá');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (545,'Estampillas','Gran Bretaña');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (546,'Estampillas','África');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (547,'Estampillas','Asia');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (548,'Estampillas','Australia y Oceanía');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (549,'Estampillas','Colonias británicas y territorios');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (550,'Estampillas','Caribe');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (551,'Estampillas','Europa');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (552,'Estampillas','Latinoamérica');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (553,'Estampillas','Oriente Medio');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (554,'Estampillas','Mundiales');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (555,'Estampillas','Estampillas tropicales');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (556,'Estampillas','Filatelia especializada');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (557,'Estampillas','Publicaciones y suministros');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (558,'Estampillas','Otros');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (559,'Boletos y experiencias','Boletos para deportes');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (560,'Boletos y experiencias','Boletos para conciertos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (561,'Boletos y experiencias','Boletos para el teatro');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (562,'Boletos y experiencias','Pases para parques temáticos y clubes');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (563,'Boletos y experiencias','Pases de estacionamiento');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (564,'Boletos y experiencias','Experiencias especiales');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (565,'Boletos y experiencias','Otros');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (566,'Juguetes y pasatiempos','Figuras de acción');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (567,'Juguetes y pasatiempos','Afelpados con pelotas de semillas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (568,'Juguetes y pasatiempos','Juguetes de construcción');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (569,'Juguetes y pasatiempos','Juguetes clásicos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (570,'Juguetes y pasatiempos','Vehículos de presofusión y de juguete');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (571,'Juguetes y pasatiempos','Educativos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (572,'Juguetes y pasatiempos','Electrónicos, baterías y a cuerda');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (573,'Juguetes y pasatiempos','Juguetes de comida rápida y cereales');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (574,'Juguetes y pasatiempos','Juegos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (575,'Juguetes y pasatiempos','Canicas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (576,'Juguetes y pasatiempos','Modelos de ferrocarriles y trenes');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (577,'Juguetes y pasatiempos','Modelos y juegos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (578,'Juguetes y pasatiempos','Juguetes y estructuras para exterior');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (579,'Juguetes y pasatiempos','Juguetes preescolares y juegos de roles');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (580,'Juguetes y pasatiempos','Rompecabezas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (581,'Juguetes y pasatiempos','Control por radio y mando');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (582,'Juguetes y pasatiempos','Robots, monstruos y juguetes del espacio');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (583,'Juguetes y pasatiempos','Automóviles con ranuras');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (584,'Juguetes y pasatiempos','Animales de peluche');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (585,'Juguetes y pasatiempos','Soldados de juguete');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (586,'Juguetes y pasatiempos','Juegos de cartas intercambiables');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (587,'Juguetes y pasatiempos','Juguetes de personajes, TV y películas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (588,'Juguetes y pasatiempos','Juguetes antiguos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (589,'Viaje','Línea aérea');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (590,'Viaje','Camping y casas rodantes');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (591,'Viaje','Alquiler de automóviles');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (592,'Viaje','Cruceros');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (593,'Viaje','Alojamiento');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (594,'Viaje','Equipaje');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (595,'Viaje','Accesorios para equipaje');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (596,'Viaje','Mapas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (597,'Viaje','Ferrocarril');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (598,'Viaje','Accesorios de viaje');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (599,'Viaje','Paquetes de vacaciones');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (600,'Viaje','Otros');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (601,'Videojuegos y consolas','Videojuegos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (602,'Videojuegos y consolas','Consolas de videojuego');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (603,'Videojuegos y consolas','Accesorios de videojuegos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (604,'Videojuegos y consolas','Tarjetas de juego prepagadas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (605,'Videojuegos y consolas','Piezas y herramientas de repuesto');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (606,'Videojuegos y consolas','Guías de estrategia y trampas');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (607,'Videojuegos y consolas','Productos de videojuegos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (608,'Videojuegos y consolas','Otros');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (609,'Todo lo demás','Solo para adultos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (610,'Todo lo demás','Desarrollo profesional y educación');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (611,'Todo lo demás','Ofertas especiales de eBay');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (612,'Todo lo demás','Herramientas de usuario de eBay');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (613,'Todo lo demás','Funeral y cementerio');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (614,'Todo lo demás','Genealogía');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (615,'Todo lo demás','Productos de información');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (616,'Todo lo demás','Metafísica');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (617,'Todo lo demás','Desarrollo personal');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (618,'Todo lo demás','Seguridad personal');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (619,'Todo lo demás','Productos y suministros religiosos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (620,'Todo lo demás','Programa de puntos e incentivos');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (621,'Todo lo demás','Artículos extraños');
Insert into SYSTEM.BUSQUEDA (ID_BUSQUEDA,CATEGORIA_PRIMARIA,CATEGORIA_SECUNDARIA) values (622,'Todo lo demás','Otros');
REM INSERTING into SYSTEM.CLASIFICACION
SET DEFINE OFF;
REM INSERTING into SYSTEM.COMPRADOR
SET DEFINE OFF;
Insert into SYSTEM.COMPRADOR (ID_PARTICIPANTE,CORREOELECTRONICO,NOMBRE,ALIAS,PASSWORD,TELEFONO,FOREIGNKEY_ADMINISTRADOR) values (1,'lts@gustr.com','Ligia Toledo Soto','ligia','ligiapw',67228161,41);
Insert into SYSTEM.COMPRADOR (ID_PARTICIPANTE,CORREOELECTRONICO,NOMBRE,ALIAS,PASSWORD,TELEFONO,FOREIGNKEY_ADMINISTRADOR) values (2,'cbm@gustr.com','Cesario Briones Madrigal','cesar','cesarpw',60676016,22);
Insert into SYSTEM.COMPRADOR (ID_PARTICIPANTE,CORREOELECTRONICO,NOMBRE,ALIAS,PASSWORD,TELEFONO,FOREIGNKEY_ADMINISTRADOR) values (3,'ohr@gustr.com','Oscar Henríquez Robledo','oscar','oscarpw',84934609,41);
Insert into SYSTEM.COMPRADOR (ID_PARTICIPANTE,CORREOELECTRONICO,NOMBRE,ALIAS,PASSWORD,TELEFONO,FOREIGNKEY_ADMINISTRADOR) values (4,'sha@ic43.com','Selena Huerta Alcalá','selen','selenpw',23653849,22);
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.METODODEPAGO
SET DEFINE OFF;
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.PARTES
SET DEFINE OFF;
Insert into SYSTEM.PARTES (CODIGO,NOMBRE) values ('e3d','esquina3d');
Insert into SYSTEM.PARTES (CODIGO,NOMBRE) values ('lam','lamina');
Insert into SYSTEM.PARTES (CODIGO,NOMBRE) values ('tco','tornillo-corto');
Insert into SYSTEM.PARTES (CODIGO,NOMBRE) values ('tla','tornillo-largo');
Insert into SYSTEM.PARTES (CODIGO,NOMBRE) values ('tue','tuerca');
REM INSERTING into SYSTEM.PARTICIPANTE
SET DEFINE OFF;
Insert into SYSTEM.PARTICIPANTE (ID_PARTICIPANTE,CORREOELECTRONICO,NOMBRE,ALIAS,PASSWORD,TELEFONO,FOREIGNKEY_ADMINISTRADOR) values (1,'sha@ic43.com','Selena Huerta Alcalá','selen','selenpw',23653849,22);
Insert into SYSTEM.PARTICIPANTE (ID_PARTICIPANTE,CORREOELECTRONICO,NOMBRE,ALIAS,PASSWORD,TELEFONO,FOREIGNKEY_ADMINISTRADOR) values (2,'cbm@gustr.com','Cesario Briones Madrigal','cesar','cesarpw',60676016,22);
Insert into SYSTEM.PARTICIPANTE (ID_PARTICIPANTE,CORREOELECTRONICO,NOMBRE,ALIAS,PASSWORD,TELEFONO,FOREIGNKEY_ADMINISTRADOR) values (3,'bmc@ic43.com','Basileo Mata Cardona','basil','basilpw',83273025,22);
Insert into SYSTEM.PARTICIPANTE (ID_PARTICIPANTE,CORREOELECTRONICO,NOMBRE,ALIAS,PASSWORD,TELEFONO,FOREIGNKEY_ADMINISTRADOR) values (4,'jcr@ic43.com','Julia Carvajal Robles','julia','juliapw',87799157,22);
Insert into SYSTEM.PARTICIPANTE (ID_PARTICIPANTE,CORREOELECTRONICO,NOMBRE,ALIAS,PASSWORD,TELEFONO,FOREIGNKEY_ADMINISTRADOR) values (5,'ohr@gustr.com','Oscar Henríquez Robledo','oscar','oscarpw',84934609,41);
Insert into SYSTEM.PARTICIPANTE (ID_PARTICIPANTE,CORREOELECTRONICO,NOMBRE,ALIAS,PASSWORD,TELEFONO,FOREIGNKEY_ADMINISTRADOR) values (6,'lts@gustr.com','Ligia Toledo Soto','ligia','ligiapw',67228161,41);
REM INSERTING into SYSTEM.PUJA
SET DEFINE OFF;
Insert into SYSTEM.PUJA (ID_PUJA,OFRECIDO,FECHA,FOREIGNKEY_SUBASTA,FOREIGNKEY_COMPRADOR) values (1,125000,to_date('23-APR-21','DD-MON-RR'),4,1);
Insert into SYSTEM.PUJA (ID_PUJA,OFRECIDO,FECHA,FOREIGNKEY_SUBASTA,FOREIGNKEY_COMPRADOR) values (2,125001,to_date('23-APR-21','DD-MON-RR'),4,2);
Insert into SYSTEM.PUJA (ID_PUJA,OFRECIDO,FECHA,FOREIGNKEY_SUBASTA,FOREIGNKEY_COMPRADOR) values (3,130000,to_date('23-APR-21','DD-MON-RR'),4,2);
Insert into SYSTEM.PUJA (ID_PUJA,OFRECIDO,FECHA,FOREIGNKEY_SUBASTA,FOREIGNKEY_COMPRADOR) values (4,137000,to_date('23-APR-21','DD-MON-RR'),4,4);
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.SUBASTA
SET DEFINE OFF;
Insert into SYSTEM.SUBASTA (ID_SUBASTA,IMAGEN,DESCRIPCION,DETALLESENTREGA,PRECIOBASE,PRECIOFINAL,FECHAINICIO,FECHAFINAL,FOREIGNKEY_VENDEDOR,FOREIGNKEY_BUSQUEDA) values (4, BFILENAME ('IMG', 'Downloads\guitarra.jpg'),'Instrumento musical guitarra','A acordar por correo',120000,137000,to_date('23-APR-21','DD-MON-RR'),to_date('23-APR-21','DD-MON-RR'),1,479);
Insert into SYSTEM.SUBASTA (ID_SUBASTA,IMAGEN,DESCRIPCION,DETALLESENTREGA,PRECIOBASE,PRECIOFINAL,FECHAINICIO,FECHAFINAL,FOREIGNKEY_VENDEDOR,FOREIGNKEY_BUSQUEDA) values (5, BFILENAME ('IMG', 'jacket.png'),'Jacket','Contactar con el vendedor',167000,167000,to_date('23-APR-21','DD-MON-RR'),to_date('23-APR-21','DD-MON-RR'),2,531);
Insert into SYSTEM.SUBASTA (ID_SUBASTA,IMAGEN,DESCRIPCION,DETALLESENTREGA,PRECIOBASE,PRECIOFINAL,FECHAINICIO,FECHAFINAL,FOREIGNKEY_VENDEDOR,FOREIGNKEY_BUSQUEDA) values (6, BFILENAME ('IMG', 'jacket.png'),'Jacket','Contactar con el vendedor',167000,167000,to_date('23-APR-21','DD-MON-RR'),to_date('23-APR-21','DD-MON-RR'),2,531);
REM INSERTING into SYSTEM.VENDEDOR
SET DEFINE OFF;
Insert into SYSTEM.VENDEDOR (ID_PARTICIPANTE,CORREOELECTRONICO,NOMBRE,ALIAS,PASSWORD,TELEFONO,FOREIGNKEY_ADMINISTRADOR,CALIFICACION) values (1,'bmc@ic43.com','Basileo Mata Cardona','basil','basilpw',83273025,22,0);
Insert into SYSTEM.VENDEDOR (ID_PARTICIPANTE,CORREOELECTRONICO,NOMBRE,ALIAS,PASSWORD,TELEFONO,FOREIGNKEY_ADMINISTRADOR,CALIFICACION) values (2,'lts@gustr.com','Ligia Toledo Soto','ligia','ligiapw',67228161,41,0);
--------------------------------------------------------
--  DDL for Index ADMINISTRADOR_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."ADMINISTRADOR_PK" ON "SYSTEM"."ADMINISTRADOR" ("ID_ADMINISTRADOR") 
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index BUSQUEDA_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."BUSQUEDA_PK" ON "SYSTEM"."BUSQUEDA" ("ID_BUSQUEDA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PK_COMPRADOR
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_COMPRADOR" ON "SYSTEM"."COMPRADOR" ("ID_PARTICIPANTE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PK_PARTICIPANTE
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_PARTICIPANTE" ON "SYSTEM"."PARTICIPANTE" ("ID_PARTICIPANTE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."PK_VENDEDOR" ON "SYSTEM"."VENDEDOR" ("ID_PARTICIPANTE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PUJA_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PUJA_PK" ON "SYSTEM"."PUJA" ("ID_PUJA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index SUBASTA_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."SUBASTA_PK" ON "SYSTEM"."SUBASTA" ("ID_SUBASTA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."TABLE1_PK" ON "SYSTEM"."CLASIFICACION" ("ID_CLASIFICACION") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
BEGIN
    ...
    WHERE :NEW.OFRECIDO > PRECIOFINAL AND :NEW.FOREIGNKEY_SUBASTA = ID_SUBASTA;
END;
/
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."DELETE_ADMINISTRADOR" (ID_A INT)
IS
BEGIN
UPDATE Participante SET ForeignKey_Administrador = 0
WHERE ID_A = Participante.ForeignKey_Administrador;
DELETE FROM Administrador A
	WHERE A.ID_Administrador = ID_A;
END;

/

  GRANT EXECUTE ON "SYSTEM"."DELETE_ADMINISTRADOR" TO "ADMINISTRADORES";
--------------------------------------------------------
--  DDL for Procedure DELETE_BUSQUEDA
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."DELETE_BUSQUEDA" (ID_B INT)
IS
BEGIN
...
/
  ...
  GRANT EXECUTE ON "SYSTEM"."DELETE_BUSQUEDA" TO "ADMINISTRADORES";
--------------------------------------------------------
--  DDL for Procedure DELETE_CLASIFICACION
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."DELETE_CLASIFICACION" (ID_C INT)
IS
BEGIN
...
/
  ...
  GRANT EXECUTE ON "SYSTEM"."DELETE_CLASIFICACION" TO "ADMINISTRADORES";
  GRANT EXECUTE ON "SYSTEM"."DELETE_CLASIFICACION" TO "PARTICIPANTES";
--------------------------------------------------------
--  DDL for Procedure DELETE_COMPRADOR
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."DELETE_COMPRADOR" (ID_C INT)
IS
BEGIN
DELETE FROM Comprador C
	WHERE ID_C = C.ID_Participante;
END;

/

  GRANT EXECUTE ON "SYSTEM"."DELETE_COMPRADOR" TO "ADMINISTRADORES";
  GRANT EXECUTE ON "SYSTEM"."DELETE_COMPRADOR" TO "PARTICIPANTES";
--------------------------------------------------------
--  DDL for Procedure DELETE_PARTICIPANTE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."DELETE_PARTICIPANTE" (ID_P INT)
IS
BEGIN
...
/
  ...
  GRANT EXECUTE ON "SYSTEM"."DELETE_PARTICIPANTE" TO "ADMINISTRADORES";
  GRANT EXECUTE ON "SYSTEM"."DELETE_PARTICIPANTE" TO "PARTICIPANTES";
--------------------------------------------------------
--  DDL for Procedure DELETE_PUJA
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."DELETE_PUJA" (ID_P INT)
IS
BEGIN
DELETE FROM Puja
	WHERE ID_P = ID_Puja;
...
/
  ...
  GRANT EXECUTE ON "SYSTEM"."DELETE_PUJA" TO "ADMINISTRADORES";
  GRANT EXECUTE ON "SYSTEM"."DELETE_PUJA" TO "PARTICIPANTES";
  GRANT EXECUTE ON "SYSTEM"."DELETE_PUJA" TO PUBLIC;
--------------------------------------------------------
--  DDL for Procedure DELETE_SUBASTA
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."DELETE_SUBASTA" (ID_S INT)
IS
BEGIN
DELETE FROM Subasta
...
/
  ...
  GRANT EXECUTE ON "SYSTEM"."DELETE_SUBASTA" TO "ADMINISTRADORES";
  GRANT EXECUTE ON "SYSTEM"."DELETE_SUBASTA" TO "PARTICIPANTES";
  GRANT EXECUTE ON "SYSTEM"."DELETE_SUBASTA" TO PUBLIC;
--------------------------------------------------------
--  DDL for Procedure DELETE_VENDEDOR
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."DELETE_VENDEDOR" (ID_V INT)
IS
BEGIN
...
/
  ...
  GRANT EXECUTE ON "SYSTEM"."DELETE_VENDEDOR" TO "ADMINISTRADORES";
  GRANT EXECUTE ON "SYSTEM"."DELETE_VENDEDOR" TO "PARTICIPANTES";
--------------------------------------------------------
--  DDL for Procedure INSERT_ADMIN
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."INSERT_ADMIN" (New_Alias varchar, New_Password varchar)
IS
BEGIN
IF LENGTH(New_Alias) < 21 AND LENGTH(New_Password) >= 8 AND LENGTH(New_Password) < 16 THEN
	INSERT INTO Administrador(Administrador.Alias, Administrador.Password)
...
/
  ...
  GRANT EXECUTE ON "SYSTEM"."INSERT_ADMIN" TO "ADMINISTRADORES";
--------------------------------------------------------
--  DDL for Procedure INSERT_BUSQUEDA
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."INSERT_BUSQUEDA" (CP varchar, CSS varchar)
IS
BEGIN
...
/
  ...
  GRANT EXECUTE ON "SYSTEM"."INSERT_BUSQUEDA" TO "ADMINISTRADORES";
--------------------------------------------------------
--  DDL for Procedure INSERT_CLASIFICACION
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."INSERT_CLASIFICACION" (FK_V int, FK_C int, Punt int, Des varchar)
IS
BEGIN
INSERT INTO Clasificacion(
	ForeignKey_Vendedor, ForeignKey_Comprador, Puntaje, Descripcion)
	VALUES (FK_V, FK_C, Punt, Des);
END;

/

  GRANT EXECUTE ON "SYSTEM"."INSERT_CLASIFICACION" TO "ADMINISTRADORES";
  GRANT EXECUTE ON "SYSTEM"."INSERT_CLASIFICACION" TO "PARTICIPANTES";
  GRANT EXECUTE ON "SYSTEM"."INSERT_CLASIFICACION" TO PUBLIC;
--------------------------------------------------------
--  DDL for Procedure INSERT_COMPRADOR
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."INSERT_COMPRADOR" (ID_P int, CEE varchar, Nom varchar, New_Alias varchar, Tel numeric, FK_A int, New_Password varchar)
IS
BEGIN
IF LENGTH(New_Alias) < 21 AND LENGTH(New_Password) >= 8 AND LENGTH(New_Password) < 16 THEN
	INSERT INTO Comprador(
	ID_Participante, CorreoElectronico, Nombre, Comprador.Alias, Telefono, ForeignKey_Administrador, Comprador.Password)
	VALUES (ID_P, CEE, Nom, New_Alias, Tel, FK_A, New_Password);
END IF;
END;

/

  GRANT EXECUTE ON "SYSTEM"."INSERT_COMPRADOR" TO "ADMINISTRADORES";
--------------------------------------------------------
--  DDL for Procedure INSERT_PARTICIPANTE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."INSERT_PARTICIPANTE" (ID_P int, CEE varchar, Nom varchar, New_Alias varchar, Tel numeric, FK_A int, New_Password varchar)
IS
BEGIN
IF LENGTH(New_Alias) < 21 AND LENGTH(New_Password) >= 8 AND LENGTH(New_Password) < 16 THEN
	INSERT INTO Participante(
	ID_Participante, CorreoElectronico, Nombre, Participante.Alias, Telefono, ForeignKey_Administrador, Participante.Password)
	VALUES (ID_P, CEE, Nom, New_Alias, Tel, FK_A, New_Password);
END IF;
END;
...
/
  ...
  GRANT EXECUTE ON "SYSTEM"."INSERT_PARTICIPANTE" TO "ADMINISTRADORES";
--------------------------------------------------------
--  DDL for Procedure INSERT_PUJA
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."INSERT_PUJA" (id_p int, Ofrecido numeric, F date, FK_S int, FK_C int)
IS
BEGIN
	INSERT INTO Puja(ID_PUJA,
    Ofrecido, Fecha, ForeignKey_Subasta, ForeignKey_Comprador)
	VALUES (id_p,Ofrecido, F, FK_S, FK_C);
END;

/

  GRANT EXECUTE ON "SYSTEM"."INSERT_PUJA" TO "ADMINISTRADORES";
  GRANT EXECUTE ON "SYSTEM"."INSERT_PUJA" TO "PARTICIPANTES";
  GRANT EXECUTE ON "SYSTEM"."INSERT_PUJA" TO PUBLIC;
--------------------------------------------------------
--  DDL for Procedure INSERT_SUBASTA
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."INSERT_SUBASTA" (Img bfile, Des varchar, DetEntrega varchar, Precio numeric, FechaI date, FechaF date, FK_V int, FK_B int)
IS
BEGIN
IF Precio >= 0 THEN
	INSERT INTO Subasta(
	Imagen, Descripcion, DetallesEntrega, PrecioBase, FechaInicio, FechaFinal, ForeignKey_Vendedor, ForeignKey_Busqueda,PrecioFinal)
	VALUES (Img, Des, DetEntrega, Precio, FechaI, FechaF, FK_V, FK_B,Precio);
END IF;
END;

/

  GRANT EXECUTE ON "SYSTEM"."INSERT_SUBASTA" TO "ADMINISTRADORES";
  GRANT EXECUTE ON "SYSTEM"."INSERT_SUBASTA" TO "PARTICIPANTES";
  GRANT EXECUTE ON "SYSTEM"."INSERT_SUBASTA" TO PUBLIC;
--------------------------------------------------------
--  DDL for Procedure INSERT_VENDEDOR
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."INSERT_VENDEDOR" (ID_P int, CEE varchar, Nom varchar, New_Alias varchar, Tel numeric, FK_A int, New_Password varchar)
IS
BEGIN
IF LENGTH(New_Alias) < 21 AND LENGTH(New_Password) >= 8 AND LENGTH(New_Password) < 16 THEN
	INSERT INTO Vendedor(
	ID_Participante, CorreoElectronico, Nombre, Vendedor.Alias, Telefono, ForeignKey_Administrador, Vendedor.Password)
	VALUES (ID_P, CEE, Nom, New_Alias, Tel, FK_A, New_Password);
END IF;
END;
...
/
  ...
  GRANT EXECUTE ON "SYSTEM"."INSERT_VENDEDOR" TO "ADMINISTRADORES";
--------------------------------------------------------
--  DDL for Procedure UPDATE_ADMIN
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."UPDATE_ADMIN" 
(
  ID_A IN NUMBER 
, NEW_ALIAS IN VARCHAR2 
, NEW_PASSWORD IN VARCHAR2 
) AS 
BEGIN
  UPDATE Administrador
	SET Administrador.Alias=New_Alias, Administrador.Password=New_Password
	WHERE LENGTH(NEW_ALIAS) < 21 AND LENGTH(NEW_PASSWORD) >= 8 AND LENGTH(NEW_PASSWORD) < 16 AND Administrador.ID_Administrador = ID_A;
END UPDATE_ADMIN;

/

  GRANT EXECUTE ON "SYSTEM"."UPDATE_ADMIN" TO "ADMINISTRADORES";
--------------------------------------------------------
--  DDL for Procedure UPDATE_BUSQUEDA
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."UPDATE_BUSQUEDA" 
(ID_B IN NUMBER , CP IN VARCHAR2 , CSS IN VARCHAR2 ) AS 
BEGIN
UPDATE Busqueda
	SET Categoria_Primaria=CP, Categoria_Secundaria=CSS
	WHERE ID_B=ID_Busqueda;
END Update_Busqueda;

/

  GRANT EXECUTE ON "SYSTEM"."UPDATE_BUSQUEDA" TO "ADMINISTRADORES";
--------------------------------------------------------
--  DDL for Procedure UPDATE_CLASIFICACION
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."UPDATE_CLASIFICACION" 
(ID_C int, FK_V int, FK_C int, Punt int, Des varchar) AS 
BEGIN
UPDATE Clasificacion
	SET ID_Clasificacion=ID_C, ForeignKey_Vendedor=FK_V, ForeignKey_Comprador=FK_C, Puntaje=Punt, Descripcion=Des
	WHERE ID_C = ID_Clasificacion;
END Update_Clasificacion;

/

  GRANT EXECUTE ON "SYSTEM"."UPDATE_CLASIFICACION" TO "ADMINISTRADORES";
  GRANT EXECUTE ON "SYSTEM"."UPDATE_CLASIFICACION" TO "PARTICIPANTES";
  GRANT EXECUTE ON "SYSTEM"."UPDATE_CLASIFICACION" TO PUBLIC;
--------------------------------------------------------
--  DDL for Procedure UPDATE_COMPRADOR
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."UPDATE_COMPRADOR" 
(ID_C int, CEE varchar, Nom varchar, New_Alias varchar, Tel numeric, FK_A int, New_Password varchar) AS 
BEGIN
IF LENGTH(New_Alias) < 21 AND LENGTH(New_Password) >= 8 AND LENGTH(New_Password) < 16 THEN
UPDATE Comprador
	SET CorreoElectronico=CEE, Nombre=Nom, Comprador.Alias=New_Alias, Telefono=Tel, ForeignKey_Administrador=FK_A, Comprador.Password=New_Password
	WHERE ID_C = ID_Participante;
END IF;
END Update_Comprador;

/

  GRANT EXECUTE ON "SYSTEM"."UPDATE_COMPRADOR" TO "ADMINISTRADORES";
--------------------------------------------------------
--  DDL for Procedure UPDATE_PARTICIPANTE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."UPDATE_PARTICIPANTE" 
(ID_C int, CEE varchar, Nom varchar, New_Alias varchar, Tel numeric, FK_A int, New_Password varchar) AS 
BEGIN
IF LENGTH(New_Alias) < 21 AND LENGTH(New_Password) >= 8 AND LENGTH(New_Password) < 16 THEN
UPDATE Participante
	SET CorreoElectronico=CEE, Nombre=Nom, Participante.Alias=New_Alias, Telefono=Tel, ForeignKey_Administrador=FK_A, Participante.Password=New_Password
	WHERE ID_C = ID_Participante;
END IF;
END Update_Participante;

/

  GRANT EXECUTE ON "SYSTEM"."UPDATE_PARTICIPANTE" TO "ADMINISTRADORES";
--------------------------------------------------------
--  DDL for Procedure UPDATE_PUJA
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."UPDATE_PUJA" 
(ID_P integer, Ofr numeric, f date, FK_S int, FK_C int) AS 
BEGIN
UPDATE Puja
	SET ID_Puja=ID_P, Ofrecido=Ofr, Fecha=f, ForeignKey_Subasta=FK_S, ForeignKey_Comprador=FK_C
	WHERE ID_P = ID_Puja;
END Update_Puja;

/

  GRANT EXECUTE ON "SYSTEM"."UPDATE_PUJA" TO "ADMINISTRADORES";
  GRANT EXECUTE ON "SYSTEM"."UPDATE_PUJA" TO "PARTICIPANTES";
  GRANT EXECUTE ON "SYSTEM"."UPDATE_PUJA" TO PUBLIC;
--------------------------------------------------------
--  DDL for Procedure UPDATE_SUBASTA
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."UPDATE_SUBASTA" 
(ID_S int, Img bfile, Des varchar, DetEntrega varchar, Precio int, FechaI date, FechaF date, FK_V int, FK_B int) AS 
BEGIN
UPDATE Subasta
	SET ID_Subasta=ID_S, Imagen=Img, Descripcion=Des, DetallesEntrega=DetEntrega, PrecioBase=Precio, FechaInicio=FechaI, FechaFinal=FechaF, ForeignKey_Vendedor=FK_V, ForeignKey_Busqueda=FK_B
	WHERE ID_S=ID_Subasta;
END Update_Subasta;

/

  GRANT EXECUTE ON "SYSTEM"."UPDATE_SUBASTA" TO "ADMINISTRADORES";
  GRANT EXECUTE ON "SYSTEM"."UPDATE_SUBASTA" TO "PARTICIPANTES";
  GRANT EXECUTE ON "SYSTEM"."UPDATE_SUBASTA" TO PUBLIC;
--------------------------------------------------------
--  DDL for Procedure UPDATE_VENDEDOR
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."UPDATE_VENDEDOR" 
(ID_C int, CEE varchar, Nom varchar, New_Alias varchar, Tel numeric, FK_A int, New_Password varchar) AS 
BEGIN
IF LENGTH(New_Alias) < 21 AND LENGTH(New_Password) >= 8 AND LENGTH(New_Password) < 16 THEN
UPDATE Vendedor
	SET CorreoElectronico=CEE, Nombre=Nom, Vendedor.Alias=New_Alias, Telefono=Tel, ForeignKey_Administrador=FK_A, Vendedor.Password=New_Password
	WHERE ID_C = ID_Participante;
END IF;
END Update_Vendedor;
...
/
  ...
  GRANT EXECUTE ON "SYSTEM"."UPDATE_VENDEDOR" TO "ADMINISTRADORES";
--------------------------------------------------------
--  DDL for Function LIST_CAT_Y_SUBCAT
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."LIST_CAT_Y_SUBCAT" (CP varchar,CSS varchar)
RETURN int
AS
   v_Cur SYS_REFCURSOR;
   v_Rec SUBASTA%ROWTYPE;
BEGIN
   v_Cur := list_cat_y_subcat_fnc(CP,CSS);
   LOOP
      FETCH v_Cur INTO v_Rec;
      EXIT WHEN v_Cur%NOTFOUND;
      DBMS_OUTPUT.PUT_LINE('Row: '|| v_Rec.ID_SUBASTA || ' ' || v_Rec.DESCRIPCION || ' ' || v_Rec.DETALLESENTREGA || ' ' || v_Rec.PRECIOBASE || ' ' || v_Rec.PRECIOFINAL || ' ' || v_Rec.FECHAINICIO || ' ' || v_Rec.FECHAFINAL || ' ' || v_Rec.FOREIGNKEY_VENDEDOR || ' ' || v_Rec.FOREIGNKEY_BUSQUEDA);
   END LOOP;
   CLOSE v_Cur;
   RETURN 0;
END;
...
/
  ...
  GRANT EXECUTE ON "SYSTEM"."LIST_CAT_Y_SUBCAT" TO "ADMINISTRADORES";
  GRANT EXECUTE ON "SYSTEM"."LIST_CAT_Y_SUBCAT" TO "PARTICIPANTES";
  GRANT EXECUTE ON "SYSTEM"."LIST_CAT_Y_SUBCAT" TO "admin1";
  GRANT EXECUTE ON "SYSTEM"."LIST_CAT_Y_SUBCAT" TO PUBLIC;
--------------------------------------------------------
--  DDL for Function LIST_CAT_Y_SUBCAT_FNC
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."LIST_CAT_Y_SUBCAT_FNC" (CP varchar, CSS varchar)
RETURN SYS_REFCURSOR
AS
cursorx SYS_REFCURSOR;
BEGIN
    OPEN cursorx FOR SELECT 
	...
	AND CP = Busqueda.Categoria_Primaria
	AND CSS = Busqueda.Categoria_Secundaria
...
/
  ...
  GRANT EXECUTE ON "SYSTEM"."LIST_CAT_Y_SUBCAT_FNC" TO PUBLIC;
--------------------------------------------------------
--  DDL for Function LIST_HISTORIAL_PUJAS
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."LIST_HISTORIAL_PUJAS" (id_s int)
RETURN int
AS
   v_Cur SYS_REFCURSOR;
   v_Rec PUJA%ROWTYPE;
BEGIN
   v_Cur := list_historial_pujas_fnc(id_s);
   LOOP
      FETCH v_Cur INTO v_Rec;
      EXIT WHEN v_Cur%NOTFOUND;
      DBMS_OUTPUT.PUT_LINE('Row: '|| v_Rec.ID_PUJA || ' ' || v_Rec.OFRECIDO || ' ' || v_Rec.FECHA || ' ' || v_Rec.FOREIGNKEY_SUBASTA || ' ' || v_Rec.FOREIGNKEY_COMPRADOR);
   END LOOP;
   CLOSE v_Cur;
   RETURN 0;
END;
...
/
  ...
  GRANT EXECUTE ON "SYSTEM"."LIST_HISTORIAL_PUJAS" TO "ADMINISTRADORES";
  GRANT EXECUTE ON "SYSTEM"."LIST_HISTORIAL_PUJAS" TO "PARTICIPANTES";
  GRANT EXECUTE ON "SYSTEM"."LIST_HISTORIAL_PUJAS" TO PUBLIC;
--------------------------------------------------------
--  DDL for Function LIST_HISTORIAL_PUJAS_FNC
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."LIST_HISTORIAL_PUJAS_FNC" (id_s int)
RETURN SYS_REFCURSOR
AS
cursorx SYS_REFCURSOR;
BEGIN
    OPEN cursorx FOR SELECT ID_Puja, Ofrecido, Fecha, ForeignKey_Subasta, ForeignKey_Comprador
	FROM Puja
	INNER JOIN Subasta
...
/
  ...
  GRANT EXECUTE ON "SYSTEM"."LIST_HISTORIAL_PUJAS_FNC" TO PUBLIC;
--------------------------------------------------------
--  DDL for Function LIST_HISTORIAL_SUBASTAS
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."LIST_HISTORIAL_SUBASTAS" (id_c int)
RETURN int
AS
   v_Cur SYS_REFCURSOR;
   v_Rec SUBASTA%ROWTYPE;
BEGIN
   v_Cur := list_historial_subastas_fnc(id_c);
   LOOP
      FETCH v_Cur INTO v_Rec;
      EXIT WHEN v_Cur%NOTFOUND;
      DBMS_OUTPUT.PUT_LINE('Row: '|| v_Rec.PrecioFinal || ' ' || v_Rec.PrecioBase || ' ' || v_Rec.Descripcion || ' ' || v_Rec.DetallesEntrega);
   END LOOP;
   CLOSE v_Cur;
   RETURN 0;
END;
...
/
  ...
  GRANT EXECUTE ON "SYSTEM"."LIST_HISTORIAL_SUBASTAS" TO "ADMINISTRADORES";
  GRANT EXECUTE ON "SYSTEM"."LIST_HISTORIAL_SUBASTAS" TO "PARTICIPANTES";
  GRANT EXECUTE ON "SYSTEM"."LIST_HISTORIAL_SUBASTAS" TO PUBLIC;
--------------------------------------------------------
--  DDL for Function LIST_HISTORIAL_SUBASTAS_FNC
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."LIST_HISTORIAL_SUBASTAS_FNC" (id_v int)
RETURN SYS_REFCURSOR
AS
cursorx SYS_REFCURSOR;
BEGIN
    OPEN cursorx FOR SELECT PrecioBase, PrecioFinal, Clasificacion.Descripcion
	FROM Subasta
	INNER JOIN Puja
...
/
  ...
  GRANT EXECUTE ON "SYSTEM"."LIST_HISTORIAL_SUBASTAS_FNC" TO PUBLIC;
--------------------------------------------------------
--  DDL for Function LIST_SUBASTAS_GANADAS
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."LIST_SUBASTAS_GANADAS" (id_c int)
RETURN int
AS
   v_Cur SYS_REFCURSOR;
   v_Rec SUBASTA%ROWTYPE;
BEGIN
   v_Cur := list_subastas_ganadas_fnc(id_c);
   LOOP
      FETCH v_Cur INTO v_Rec;
      EXIT WHEN v_Cur%NOTFOUND;
      DBMS_OUTPUT.PUT_LINE('Row: '|| v_Rec.PrecioFinal || ' ' || v_Rec.PrecioBase || ' ' || v_Rec.Descripcion || ' ' || v_Rec.DetallesEntrega);
...
/
  ...
  GRANT EXECUTE ON "SYSTEM"."LIST_SUBASTAS_GANADAS" TO "ADMINISTRADORES";
  GRANT EXECUTE ON "SYSTEM"."LIST_SUBASTAS_GANADAS" TO "PARTICIPANTES";
  GRANT EXECUTE ON "SYSTEM"."LIST_SUBASTAS_GANADAS" TO PUBLIC;
--------------------------------------------------------
--  DDL for Function LIST_SUBASTAS_GANADAS_FNC
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."LIST_SUBASTAS_GANADAS_FNC" (id_c int)
RETURN SYS_REFCURSOR
AS
cursorx SYS_REFCURSOR;
BEGIN
    OPEN cursorx FOR SELECT PrecioFinal,PrecioBase,Descripcion,DetallesEntrega
	FROM Subasta
...
/
  ...
  GRANT EXECUTE ON "SYSTEM"."LIST_SUBASTAS_GANADAS_FNC" TO PUBLIC;
--------------------------------------------------------
...
/
--------------------------------------------------------
--  DDL for Function SELECT_ADMIN
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."SELECT_ADMIN" 
RETURN int
AS
   v_Cur SYS_REFCURSOR;
   v_Rec ADMINISTRADOR%ROWTYPE;
BEGIN
   v_Cur := select_admin_fnc();
   LOOP
      FETCH v_Cur INTO v_Rec;
      EXIT WHEN v_Cur%NOTFOUND;
      DBMS_OUTPUT.PUT_LINE('Row: '|| v_Rec.ID_ADMINISTRADOR || ' ' || v_Rec.ALIAS || ' ' || v_Rec.PASSWORD);
   END LOOP;
   CLOSE v_Cur;
   RETURN 0;
END;
...
/
  ...
  GRANT EXECUTE ON "SYSTEM"."SELECT_ADMIN" TO "ADMINISTRADORES";
--------------------------------------------------------
--  DDL for Function SELECT_ADMIN_FNC
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."SELECT_ADMIN_FNC" 
RETURN SYS_REFCURSOR
AS
cursorx SYS_REFCURSOR;
BEGIN
    OPEN cursorx FOR SELECT * FROM ADMINISTRADOR;
    RETURN cursorx;
END;

/
--------------------------------------------------------
--  DDL for Function SELECT_BUSQUEDA
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."SELECT_BUSQUEDA" 
RETURN int
AS
   v_Cur SYS_REFCURSOR;
   v_Rec BUSQUEDA%ROWTYPE;
BEGIN
   v_Cur := select_busqueda_fnc();
   LOOP
      FETCH v_Cur INTO v_Rec;
      EXIT WHEN v_Cur%NOTFOUND;
      DBMS_OUTPUT.PUT_LINE('Row: '|| v_Rec.ID_BUSQUEDA || ' ' || v_Rec.CATEGORIA_PRIMARIA || ' ' || v_Rec.CATEGORIA_SECUNDARIA);
   END LOOP;
   CLOSE v_Cur;
   RETURN 0;
END;
...
/
  ...
  GRANT EXECUTE ON "SYSTEM"."SELECT_BUSQUEDA" TO "ADMINISTRADORES";
  GRANT EXECUTE ON "SYSTEM"."SELECT_BUSQUEDA" TO "PARTICIPANTES";
  GRANT EXECUTE ON "SYSTEM"."SELECT_BUSQUEDA" TO PUBLIC;
--------------------------------------------------------
--  DDL for Function SELECT_BUSQUEDA_FNC
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."SELECT_BUSQUEDA_FNC" 
RETURN SYS_REFCURSOR
AS
cursorx SYS_REFCURSOR;
BEGIN
    OPEN cursorx FOR SELECT * FROM BUSQUEDA;
    RETURN cursorx;
END;

/
--------------------------------------------------------
--  DDL for Function SELECT_CLASIFICACION
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."SELECT_CLASIFICACION" 
RETURN int
AS
   v_Cur SYS_REFCURSOR;
   v_Rec CLASIFICACION%ROWTYPE;
BEGIN
   v_Cur := select_clasificacion_fnc();
   LOOP
      FETCH v_Cur INTO v_Rec;
      EXIT WHEN v_Cur%NOTFOUND;
      DBMS_OUTPUT.PUT_LINE('Row: '|| v_Rec.ID_CLASIFICACION || ' ' || v_Rec.FOREIGNKEY_VENDEDOR || ' ' || v_Rec.FOREIGNKEY_COMPRADOR || ' ' || v_Rec.PUNTAJE || ' ' || v_Rec.DESCRIPCION);
   END LOOP;
   CLOSE v_Cur;
   RETURN 0;
END;
...
/
  ...
  GRANT EXECUTE ON "SYSTEM"."SELECT_CLASIFICACION" TO "ADMINISTRADORES";
  GRANT EXECUTE ON "SYSTEM"."SELECT_CLASIFICACION" TO "PARTICIPANTES";
  GRANT EXECUTE ON "SYSTEM"."SELECT_CLASIFICACION" TO PUBLIC;
--------------------------------------------------------
--  DDL for Function SELECT_CLASIFICACION_FNC
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."SELECT_CLASIFICACION_FNC" 
RETURN SYS_REFCURSOR
AS
cursorx SYS_REFCURSOR;
BEGIN
    OPEN cursorx FOR SELECT * FROM CLASIFICACION;
    RETURN cursorx;
END;

/
--------------------------------------------------------
--  DDL for Function SELECT_COMPRADOR
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."SELECT_COMPRADOR" 
RETURN int
AS
   v_Cur SYS_REFCURSOR;
   v_Rec COMPRADOR%ROWTYPE;
BEGIN
   v_Cur := select_comprador_fnc();
   LOOP
      FETCH v_Cur INTO v_Rec;
      EXIT WHEN v_Cur%NOTFOUND;
      DBMS_OUTPUT.PUT_LINE('Row: '|| v_Rec.ID_PARTICIPANTE || ' ' || v_Rec.CORREOELECTRONICO || ' ' || v_Rec.NOMBRE || ' ' || v_Rec.ALIAS || ' ' || v_Rec.PASSWORD || ' ' || v_Rec.TELEFONO || ' ' || v_Rec.FOREIGNKEY_ADMINISTRADOR);
   END LOOP;
   CLOSE v_Cur;
   RETURN 0;
END;
...
/
  ...
  GRANT EXECUTE ON "SYSTEM"."SELECT_COMPRADOR" TO "ADMINISTRADORES";
  GRANT EXECUTE ON "SYSTEM"."SELECT_COMPRADOR" TO "PARTICIPANTES";
  GRANT EXECUTE ON "SYSTEM"."SELECT_COMPRADOR" TO PUBLIC;
--------------------------------------------------------
--  DDL for Function SELECT_COMPRADOR_FNC
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."SELECT_COMPRADOR_FNC" 
RETURN SYS_REFCURSOR
AS
cursorx SYS_REFCURSOR;
BEGIN
    OPEN cursorx FOR SELECT * FROM COMPRADOR;
    RETURN cursorx;
END;

/
--------------------------------------------------------
--  DDL for Function SELECT_PARTICIPANTE
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."SELECT_PARTICIPANTE" 
RETURN int
AS
   v_Cur SYS_REFCURSOR;
   v_Rec PARTICIPANTE%ROWTYPE;
BEGIN
   v_Cur := select_participante_fnc();
   LOOP
      FETCH v_Cur INTO v_Rec;
      EXIT WHEN v_Cur%NOTFOUND;
      DBMS_OUTPUT.PUT_LINE('Row: '|| v_Rec.ID_PARTICIPANTE || ' ' || v_Rec.CORREOELECTRONICO || ' ' || v_Rec.NOMBRE || ' ' || v_Rec.ALIAS || ' ' || v_Rec.PASSWORD || ' ' || v_Rec.TELEFONO || ' ' || v_Rec.FOREIGNKEY_ADMINISTRADOR);
...
/
  ...
  GRANT EXECUTE ON "SYSTEM"."SELECT_PARTICIPANTE" TO "ADMINISTRADORES";
  GRANT EXECUTE ON "SYSTEM"."SELECT_PARTICIPANTE" TO "PARTICIPANTES";
  GRANT EXECUTE ON "SYSTEM"."SELECT_PARTICIPANTE" TO PUBLIC;
--------------------------------------------------------
--  DDL for Function SELECT_PARTICIPANTE_FNC
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."SELECT_PARTICIPANTE_FNC" 
RETURN SYS_REFCURSOR
AS
cursorx SYS_REFCURSOR;
BEGIN
    OPEN cursorx FOR SELECT * FROM Participante;
    RETURN cursorx;
END;

/
--------------------------------------------------------
--  DDL for Function SELECT_PUJA
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."SELECT_PUJA" 
RETURN int
AS
   v_Cur SYS_REFCURSOR;
   v_Rec PUJA%ROWTYPE;
BEGIN
   v_Cur := select_puja_fnc();
   LOOP
      FETCH v_Cur INTO v_Rec;
      EXIT WHEN v_Cur%NOTFOUND;
      DBMS_OUTPUT.PUT_LINE('Row: '|| v_Rec.ID_PUJA || ' ' || v_Rec.OFRECIDO || ' ' || v_Rec.FECHA || ' ' || v_Rec.FOREIGNKEY_SUBASTA || ' ' || v_Rec.FOREIGNKEY_COMPRADOR);
...
/
  ...
  GRANT EXECUTE ON "SYSTEM"."SELECT_PUJA" TO "ADMINISTRADORES";
  GRANT EXECUTE ON "SYSTEM"."SELECT_PUJA" TO "PARTICIPANTES";
  GRANT EXECUTE ON "SYSTEM"."SELECT_PUJA" TO PUBLIC;
--------------------------------------------------------
--  DDL for Function SELECT_PUJA_FNC
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."SELECT_PUJA_FNC" 
RETURN SYS_REFCURSOR
AS
cursorx SYS_REFCURSOR;
BEGIN
    OPEN cursorx FOR SELECT * FROM PUJA;
    RETURN cursorx;
END;

/
--------------------------------------------------------
--  DDL for Function SELECT_SUBASTA
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."SELECT_SUBASTA" 
RETURN int
AS
   v_Cur SYS_REFCURSOR;
   v_Rec SUBASTA%ROWTYPE;
BEGIN
   v_Cur := select_subasta_fnc();
   LOOP
      FETCH v_Cur INTO v_Rec;
      EXIT WHEN v_Cur%NOTFOUND;
      DBMS_OUTPUT.PUT_LINE('Row: '|| v_Rec.ID_SUBASTA || ' ' || v_Rec.DESCRIPCION || ' ' || v_Rec.DETALLESENTREGA || ' ' || v_Rec.PRECIOBASE || ' ' || v_Rec.PRECIOFINAL || ' ' || v_Rec.FECHAINICIO || ' ' || v_Rec.FECHAFINAL || ' ' || v_Rec.FOREIGNKEY_VENDEDOR || ' ' || v_Rec.FOREIGNKEY_BUSQUEDA);
...
/
  ...
  GRANT EXECUTE ON "SYSTEM"."SELECT_SUBASTA" TO "ADMINISTRADORES";
  GRANT EXECUTE ON "SYSTEM"."SELECT_SUBASTA" TO "PARTICIPANTES";
  GRANT EXECUTE ON "SYSTEM"."SELECT_SUBASTA" TO PUBLIC;
--------------------------------------------------------
--  DDL for Function SELECT_SUBASTA_FNC
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."SELECT_SUBASTA_FNC" 
RETURN SYS_REFCURSOR
AS
cursorx SYS_REFCURSOR;
BEGIN
    OPEN cursorx FOR SELECT * FROM SUBASTA;
    RETURN cursorx;
END;

/
--------------------------------------------------------
--  DDL for Function SELECT_VENDEDOR
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."SELECT_VENDEDOR" 
RETURN int
AS
   v_Cur SYS_REFCURSOR;
   v_Rec VENDEDOR%ROWTYPE;
BEGIN
   v_Cur := select_vendedor_fnc();
   LOOP
      FETCH v_Cur INTO v_Rec;
      EXIT WHEN v_Cur%NOTFOUND;
      DBMS_OUTPUT.PUT_LINE('Row: '|| v_Rec.ID_PARTICIPANTE || ' ' || v_Rec.CORREOELECTRONICO || ' ' || v_Rec.NOMBRE || ' ' || v_Rec.ALIAS || ' ' || v_Rec.PASSWORD || ' ' || v_Rec.TELEFONO || ' ' || v_Rec.FOREIGNKEY_ADMINISTRADOR || ' ' || v_Rec.CALIFICACION);
   END LOOP;
   CLOSE v_Cur;
   RETURN 0;
END;
...
/
  ...
  GRANT EXECUTE ON "SYSTEM"."SELECT_VENDEDOR" TO "ADMINISTRADORES";
  GRANT EXECUTE ON "SYSTEM"."SELECT_VENDEDOR" TO "PARTICIPANTES";
  GRANT EXECUTE ON "SYSTEM"."SELECT_VENDEDOR" TO PUBLIC;
--------------------------------------------------------
--  DDL for Function SELECT_VENDEDOR_FNC
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."SELECT_VENDEDOR_FNC" 
RETURN SYS_REFCURSOR
AS
cursorx SYS_REFCURSOR;
BEGIN
    OPEN cursorx FOR SELECT * FROM VENDEDOR;
    RETURN cursorx;
END;
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PUJA" MODIFY ("ID_PUJA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PUJA" MODIFY ("OFRECIDO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PUJA" MODIFY ("FECHA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PUJA" MODIFY ("FOREIGNKEY_SUBASTA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PUJA" MODIFY ("FOREIGNKEY_COMPRADOR" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PUJA" ADD CONSTRAINT "PUJA_PK" PRIMARY KEY ("ID_PUJA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."SUBASTA" MODIFY ("ID_SUBASTA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SUBASTA" MODIFY ("IMAGEN" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SUBASTA" MODIFY ("DESCRIPCION" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SUBASTA" MODIFY ("DETALLESENTREGA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SUBASTA" MODIFY ("PRECIOBASE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SUBASTA" MODIFY ("FECHAINICIO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SUBASTA" MODIFY ("FECHAFINAL" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SUBASTA" MODIFY ("FOREIGNKEY_VENDEDOR" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SUBASTA" MODIFY ("FOREIGNKEY_BUSQUEDA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SUBASTA" ADD CONSTRAINT "SUBASTA_PK" PRIMARY KEY ("ID_SUBASTA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."VENDEDOR" MODIFY ("ID_PARTICIPANTE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VENDEDOR" MODIFY ("CORREOELECTRONICO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VENDEDOR" MODIFY ("NOMBRE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VENDEDOR" MODIFY ("ALIAS" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VENDEDOR" MODIFY ("PASSWORD" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VENDEDOR" ADD CONSTRAINT "PK_VENDEDOR" PRIMARY KEY ("ID_PARTICIPANTE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."VENDEDOR" ADD UNIQUE ("SYS_NC_OID$") RELY
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PARTES" MODIFY ("CODIGO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PARTES" MODIFY ("NOMBRE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PARTES" ADD UNIQUE ("SYS_NC_OID$") RELY
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."PARTES" ADD UNIQUE ("CODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."PARTES" ADD UNIQUE ("NOMBRE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."BUSQUEDA" MODIFY ("ID_BUSQUEDA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."BUSQUEDA" MODIFY ("CATEGORIA_PRIMARIA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."BUSQUEDA" MODIFY ("CATEGORIA_SECUNDARIA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."BUSQUEDA" ADD CONSTRAINT "BUSQUEDA_PK" PRIMARY KEY ("ID_BUSQUEDA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."ADMINISTRADOR" MODIFY ("ID_ADMINISTRADOR" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ADMINISTRADOR" MODIFY ("ALIAS" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ADMINISTRADOR" ADD CONSTRAINT "ADMINISTRADOR_PK" PRIMARY KEY ("ID_ADMINISTRADOR")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PARTICIPANTE" MODIFY ("ID_PARTICIPANTE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PARTICIPANTE" MODIFY ("CORREOELECTRONICO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PARTICIPANTE" MODIFY ("NOMBRE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PARTICIPANTE" MODIFY ("ALIAS" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PARTICIPANTE" MODIFY ("PASSWORD" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PARTICIPANTE" ADD CONSTRAINT "PK_PARTICIPANTE" PRIMARY KEY ("ID_PARTICIPANTE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."PARTICIPANTE" ADD UNIQUE ("SYS_NC_OID$") RELY
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."COMPRADOR" MODIFY ("ID_PARTICIPANTE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."COMPRADOR" MODIFY ("CORREOELECTRONICO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."COMPRADOR" MODIFY ("NOMBRE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."COMPRADOR" MODIFY ("ALIAS" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."COMPRADOR" MODIFY ("PASSWORD" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."COMPRADOR" ADD CONSTRAINT "PK_COMPRADOR" PRIMARY KEY ("ID_PARTICIPANTE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."COMPRADOR" ADD UNIQUE ("SYS_NC_OID$") RELY
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CLASIFICACION" MODIFY ("ID_CLASIFICACION" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CLASIFICACION" MODIFY ("FOREIGNKEY_VENDEDOR" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CLASIFICACION" MODIFY ("FOREIGNKEY_COMPRADOR" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CLASIFICACION" MODIFY ("PUNTAJE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CLASIFICACION" ADD CONSTRAINT "CLASIFICACION_PK" PRIMARY KEY ("ID_CLASIFICACION")
  USING INDEX (CREATE UNIQUE INDEX "SYSTEM"."TABLE1_PK" ON "SYSTEM"."CLASIFICACION" ("ID_CLASIFICACION") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CLASIFICACION" ADD CONSTRAINT "CLASIFICACION_FKC" FOREIGN KEY ("FOREIGNKEY_COMPRADOR")
	  REFERENCES "SYSTEM"."COMPRADOR" ("ID_PARTICIPANTE") ENABLE;
  ALTER TABLE "SYSTEM"."CLASIFICACION" ADD CONSTRAINT "CLASIFICACION_FKV" FOREIGN KEY ("FOREIGNKEY_VENDEDOR")
	  REFERENCES "SYSTEM"."VENDEDOR" ("ID_PARTICIPANTE") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table COMPRADOR
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."COMPRADOR" ADD CONSTRAINT "FK_COMPRADOR_ADMIN" FOREIGN KEY ("FOREIGNKEY_ADMINISTRADOR")
	  REFERENCES "SYSTEM"."ADMINISTRADOR" ("ID_ADMINISTRADOR") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."MVIEW$_ADV_ROLLUP" ADD CONSTRAINT "MVIEW$_ADV_ROLLUP_PFK" FOREIGN KEY ("RUNID#", "PLEVELID#")
	  REFERENCES "SYSTEM"."MVIEW$_ADV_LEVEL" ("RUNID#", "LEVELID#") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table PARTICIPANTE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."PARTICIPANTE" ADD CONSTRAINT "FK_PARTICIPANTE_ADMIN" FOREIGN KEY ("FOREIGNKEY_ADMINISTRADOR")
	  REFERENCES "SYSTEM"."ADMINISTRADOR" ("ID_ADMINISTRADOR") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table PUJA
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."PUJA" ADD CONSTRAINT "PUJA_FKC" FOREIGN KEY ("FOREIGNKEY_COMPRADOR")
	  REFERENCES "SYSTEM"."COMPRADOR" ("ID_PARTICIPANTE") ENABLE;
  ALTER TABLE "SYSTEM"."PUJA" ADD CONSTRAINT "PUJA_FKS" FOREIGN KEY ("FOREIGNKEY_SUBASTA")
	  REFERENCES "SYSTEM"."SUBASTA" ("ID_SUBASTA") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table SUBASTA
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."SUBASTA" ADD CONSTRAINT "SUBASTA_FKB" FOREIGN KEY ("FOREIGNKEY_BUSQUEDA")
	  REFERENCES "SYSTEM"."BUSQUEDA" ("ID_BUSQUEDA") ENABLE;
  ALTER TABLE "SYSTEM"."SUBASTA" ADD CONSTRAINT "SUBASTA_FKV" FOREIGN KEY ("FOREIGNKEY_VENDEDOR")
	  REFERENCES "SYSTEM"."VENDEDOR" ("ID_PARTICIPANTE") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table VENDEDOR
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."VENDEDOR" ADD CONSTRAINT "FK_VENDEDOR_ADMIN" FOREIGN KEY ("FOREIGNKEY_ADMINISTRADOR")
	  REFERENCES "SYSTEM"."ADMINISTRADOR" ("ID_ADMINISTRADOR") ENABLE;
